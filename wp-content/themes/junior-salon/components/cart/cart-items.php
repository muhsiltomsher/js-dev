...
<div x-data="cartItemHandler('<?php echo esc_js($cart_item_key); ?>', <?php echo esc_js($cart_item['quantity']); ?>)"
    x-show="visible" class="cart-item group transition-all duration-300 bg-white p-0 overflow-hidden mb-5"
        ...
        <div
            ...
            <div class="px-4 py-2 flex gap-2 mt-2 border-t border-gray-300">
                ...
                <button type="button" @click="toggleItem()"
                    class="flex items-center !text-[13px] bg-white gap-2 cursor-pointer border border-black text-black px-4 transition-all hover:bg-yellow-100 disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                <div
                    class="flex items-center bg-white gap-2 border border-black text-black text-[14px] px-4  transition-all hover:bg-yellow-100 disabled:opacity-50 disabled:cursor-not-allowed">
